...
create table ordersdetails ( id int  , name varchar(20) , orderid int constraint YK foreign key (id) references  orders (id) on update no action )
...
select * from orders 
seklect * from ordersdetails

update orders set id=3 where id=3
